...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    if (interaction.isContextMenuCommand()) {
      const command = client.collection.contextMenuCommands.get(
      ...
      log(
        `${interaction.commandName} has been run by ${interaction.user.displayName} (ID: ${interaction.user.id})`,
        "info"
      );
              ...
              await interaction.reply({
                content:
                  config.messageSettings.cooldownMessage !== undefined &&
                    ...
                    ? config.messageSettings.cooldownMessage
                    : `Slow down broski. There is a ${command.options?.cooldown} second cooldown left.`,
              });
